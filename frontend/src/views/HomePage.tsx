...
const HomePage: React.FC = () => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100vh', width: '100%', gap: '1rem' }}>
            ...
            <button
                onClick={() => navigate('/saved-for-later')}
                style={{ padding: '10px 20px', cursor: 'pointer', backgroundColor: '#9C27B0', color: 'white', border: 'none', borderRadius: '5px' }}
            >
                Ver Guardados para más tarde
            </button>
            <button
                onClick={() => navigate('/mis-valoraciones')}
                style={{ padding: '10px 20px', cursor: 'pointer', backgroundColor: '#E91E63', color: 'white', border: 'none', borderRadius: '5px' }}
            >
                Mis Valoraciones
            </button>
